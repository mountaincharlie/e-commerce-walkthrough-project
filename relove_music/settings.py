"""
Django settings for relove_music project.
...
ALLOWED_HOSTS = ['re-love-music.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'relove_music.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media',  # to use MEDIA_URL in tmeplate tags
                'bag.contexts.bag_contents',  # function for handling shopping bag data (can now be used across entire site)
            ],
            'builtins': [
